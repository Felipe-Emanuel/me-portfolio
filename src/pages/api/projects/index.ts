  ...
  const images = [
    {
      ...
      description:
        "Apesar do projeto não apresentar uma versão responsiva, foi trabalhado o conceito lógico da programação POO com JavaScript usando o Firestore do Firebase. Foi usado Typescript para a melhor manutenção de futuras atualizações no código e TailwindCss para a estilização. Next Crud foi desenvolvido em um curso de NextJS e toda sua funcionalidade pode ser acessada de maneira fácil e, claro, o código está público no Github.",
    ...
    },
    {
      ...
      subtitle:
        "Acesse e veja o IMask em ação, uma das maiores máscaras Vanilla!",
    ...
    },
    {
      ...
      subtitle:
        "Acesse e compre moedas ou contas de Runescape 3 ou OSRS, o maior MMORPG do mundo!",
